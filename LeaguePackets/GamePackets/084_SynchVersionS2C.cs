...
namespace LeaguePackets.GamePackets
{
    public class SynchVersionS2C : GamePacket // 0x54
    {
        ...
        private PlayerLiteInfo[] _playerInfo = new PlayerLiteInfo[12];
        ...
        public PlayerLiteInfo[] PlayerInfo => _playerInfo;
        ...
        public static SynchVersionS2C CreateBody(PacketReader reader, NetID sender)
        {
            ...
            for (var i = 0; i < result.PlayerInfo.Length; i++)
                result.PlayerInfo[i] = reader.ReadPlayerLiteInfo();
        ...
        public override void WriteBody(PacketWriter writer)
        {
            ...
            for (var i = 0; i < PlayerInfo.Length; i++)
                writer.WritePlayerLiteInfo(PlayerInfo[i]);
